...
def evaluationTracking_py(res_fpath, gt_fpath, dataset):
    ...
    default_dataset_config = trackeval.datasets.DeepingSourceTop2DBox.get_default_dataset_config()
    ...
    results = res['DeepingSourceTop2DBox']['MPNTrack']['COMBINED_SEQ']['pedestrian']['CLEAR']
