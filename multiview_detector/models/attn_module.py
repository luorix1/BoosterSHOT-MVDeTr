...
class SHOTConv(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride=1, padding=0, dilation=1, groups=1, relu=True, bn=True, bias=False):
        ...
        self.out_channels = out_planes
        self.conv1 = nn.Conv2d(in_planes, 64, kernel_size=kernel_size, stride=stride, padding=padding, dilation=dilation, groups=groups, bias=bias)
        self.relu = nn.ReLU() if relu else None
        self.conv2 = nn.Conv2d(64, out_planes, kernel_size=kernel_size, stride=stride, padding=padding, dilation=dilation, groups=groups, bias=bias)
...
class SpatialGate(nn.Module):
    def __init__(self):
        ...
        self.spatial = SHOTConv(2, 1, kernel_size, stride=1, padding=(kernel_size-1) // 2, relu=False)
    def forward(self, x):
